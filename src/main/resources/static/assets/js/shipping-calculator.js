...
class ShippingCalculator {
    ...
    initSubmitButtonControl() {
        this.disableSubmitButton('Vui lòng nhập địa chỉ để tính phí giao hàng');
    }

    // Disable submit button with reason
    disableSubmitButton(reason = 'Đang tính phí giao hàng...') {
        ...
        if (addressInput && districtInput && regionInput) {
            ...
            const onAddressChange = () => {
                ...
                if (this.isAddressComplete()) {
                    this.disableSubmitButton('Đang tính phí giao hàng...');
                } else {
                    this.disableSubmitButton('Vui lòng nhập địa chỉ để tính phí giao hàng');
                }
    ...
    showError(message) {
        ...
        if (shippingInfo) {
            shippingInfo.innerHTML = `
                <div class="alert alert-danger">
                    ...
                    <p>${message}</p>
                    <small class="text-muted">Vui lòng kiểm tra lại địa chỉ và thử lại.</small>
                </div>
            `;
            shippingInfo.style.display = 'block';
        }
        ...
        this.disableSubmitButton('Không thể tính phí giao hàng - Kiểm tra địa chỉ');
    }
